...
namespace BusinessLogic.Interfaces
{
    ...
    public interface IUserService
    {
        ...
        Task<(bool Success, User User, IEnumerable<string> Errors)> RegisterCustomerUserAsync(CreateUserRequestDTO request);
        Task<(bool Success, User User, IEnumerable<string> Errors)> RegisterStoreUserAsync(CreateUserRequestDTO request);
    }
}
